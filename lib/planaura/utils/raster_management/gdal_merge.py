...
def gdal_merge(argv=None, prj_im=None, shut=False):
    verbose = 0
    quiet = 0
    names = []
    driver_name = None
    ...
    try:
        ...
        if not shut: print('File already exits; overwriting it ... ')
    except:
        if not shut: print('File does not already exits; creating it ... ')
